...
import opensesame.models.transformerxl.tokenization_transfo_xl as data_utils
from opensesame.models.transformerxl.modeling_transfo_xl import (CONFIG_NAME,
                                                         WEIGHTS_NAME,
                                                         TransfoXLConfig,
                                                         TransfoXLLMHeadModel,
                                                         load_tf_weights_in_transfo_xl)
from opensesame.models.transformerxl.tokenization_transfo_xl import (CORPUS_NAME,
                                                             VOCAB_NAME)
