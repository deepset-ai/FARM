...
class PreprocessingPipeline:
    ...
    def __init__(self,
        ...
        self.pipeline = [self.call_file_to_list,
    ...
    def call_file_to_list(self, filename):
        return self.file_to_list(filename=filename,
                                 delimiter=self.delimiter)

    def call_list_to_examples(self, data):
        return self.list_to_examples(lines=data,
                                     set_type="X")

    def call_example_to_features(self, data):
        return self.examples_to_features(examples=data,
                                         label_list=self.label_list,
                                         max_seq_len=self.max_seq_len,
                                         tokenizer=self.tokenizer)

    def call_features_to_dataset(self, data):
        return self.features_to_dataset(features=data,
...
class PPGNAD(PreprocessingPipeline):
    ...
    def __init__(self, data_dir, tokenizer, max_seq_len):
        ...
        label_list = ["Web", "Sport", "International", "Panorama", "Wissenschaft", "Wirtschaft", "Kultur", "Etat", "Inland"]
        metric = "acc"
...
class PPCONLL03(PreprocessingPipeline):
    ...
    def __init__(self, data_dir, tokenizer, max_seq_len):
        ...
        # TODO how best to format this
        label_list = ["[PAD]","O", "B-MISC", "I-MISC", "B-PER", "I-PER", "B-ORG", "I-ORG", "B-LOC", "I-LOC", "X", "B-OTH", "I-OTH", "[CLS]", "[SEP]"]
        metric = "seq_f1"
        output_mode = "classification"
        token_level = True
        ...
        super(PPCONLL03, self).__init__(file_to_list=read_ner_file,
