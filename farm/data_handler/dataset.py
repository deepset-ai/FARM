...
#     all_padding_mask = torch.tensor([f.padding_mask for f in features], dtype=torch.long)
...
#         all_input_ids, all_padding_mask, all_segment_ids, all_label_ids, all_initial_masks
#     )
#     return dataset
