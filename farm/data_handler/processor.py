...
class TextClassificationProcessor(Processor):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param task_names: If you want to use a single prediction head provide ``None`` here.
        ...
        if metric and label_list:
            ...
            if task_names is None:  # one prediction head
                ...
                for task_name, inner_label_list, inner_label_column_name in zip(task_names, label_list, label_column_name):
                    self.add_task(name=task_name,
                                  ...
                                  label_column_name=inner_label_column_name,
                                  text_column_name=text_column_name,
                                  task_type=task_type)
