...
from farm.modeling.prediction_head import QuestionAnsweringHead, TextClassificationHead, TokenClassificationHead, \
    RegressionHead, BertLMHead, PredictionHead, pick_single_fn
...
class AdaptiveModel(nn.Module, BaseAdaptiveModel):
    ...
    def convert_to_transformers(self):
        ...
        """
        return Converter.convert_to_transformers(self)
    ...
    def convert_from_transformers(cls, model_name_or_path, device, task_type=None, processor=None):
        ...
        """
        return Converter.convert_from_transformers(model_name_or_path, device, task_type, processor)
...
class Converter:
    ...
    def convert_from_transformers(model_name_or_path, device, task_type=None, processor=None):
        ...
        if task_type == "lm":
            ...
            adaptive_model = AdaptiveModel(language_model=lm, prediction_heads=[], embeds_dropout_prob=0.1,
