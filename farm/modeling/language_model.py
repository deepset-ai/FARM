        ...
        * OR a local path of a model trained via FARM ("some_dir/farm_model")
        ...
        if os.path.exists(farm_lm_config):
            ...
            if pretrained_model_name_or_path == dpr_question_encoder.transformers_modelhub_path:
                dpr_question_encoder.model.base_model.bert_model = transformers.DPRQuestionEncoder.from_pretrained(str(pretrained_model_name_or_path), **kwargs)
            else:
        ...
        * OR a local path of a model trained via FARM ("some_dir/farm_model")
        ...
        if os.path.exists(farm_lm_config):
            ...
            if pretrained_model_name_or_path == dpr_context_encoder.transformers_modelhub_path:
                dpr_context_encoder.model.base_model.bert_model = transformers.DPRContextEncoder.from_pretrained(str(pretrained_model_name_or_path), **kwargs)
            else:
