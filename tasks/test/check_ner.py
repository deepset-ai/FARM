...
tokenizer = BertTokenizer.from_pretrained("bert-base-cased-de-2b-end",
                                          do_lower_case=False)


data_bunch = NewDataBunch.load("data/conll03",
                               processor,
                               tokenizer,
                               32,
                               128,
...
data_bunch_old = NewDataBunch.load("data/conll03",
                                   processor,
                                   tokenizer,
                                   32,
                                   128,
