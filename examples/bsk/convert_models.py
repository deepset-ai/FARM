...
def convert_to_transformers():
    farm_input_dir = Path("../../../bsk-customer-service/models/xlm-roberta-large-english-SemEval2017-4a")
    transformers_output_dir = "../../../bsk-customer-service/models/huggingface/xlm-roberta-large-sentiment-SemEval17"
    #
